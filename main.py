...
shipImg = pygame.image.load("ship.JPG").convert_alpha()
pygame.Surface.set_colorkey (shipImg, [255,255,255])
shipImg2 = pygame.image.load("ship2.JPG").convert_alpha()
pygame.Surface.set_colorkey (shipImg2, [255,255,255])
...
while 1: #game loop###########################################################
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if mousePos[0]>1000 and mousePos[0] < 1200 and mousePos[1]>50 and mousePos[1]<225:
               background = 1 #castle
                ...
                background = 2 #plants
            elif mousePos[0]>1000 and mousePos[0] < 1200 and mousePos[1]>314 and mousePos[1]<625:
                background = 3 #ship
            ...
            elif mousePos[0]>25 and mousePos[0] < 200 and mousePos[1]>146 and mousePos[1]<310:
    ...
    screen.blit(shipImg2, (1011, 540))
    screen.blit(fishImg, (50, 50))
    screen.blit(fishImg2, (50, 150))
